...
@property (strong, nonatomic) CIFilter *finalFilter;
...
- (void)viewDidLoad
{
    ...
    // 得到图片路径创建CIImage对象
    beginImage = [CIImage imageWithCGImage:_selImage.CGImage];
...
{
    CIImage *saveToSave = [_finalFilter outputImage];
